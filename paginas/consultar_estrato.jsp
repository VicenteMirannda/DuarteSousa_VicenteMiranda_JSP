  ...
  <br>
    ...
    <table class="table">
      ...
      <tbody>
          ...
          PreparedStatement stmt = conn.prepareStatement("SELECT * FROM estratos_bancarios WHERE id_utilizador = ? ORDER BY id_transacao ASC");
          stmt.setInt(1, idUtilizadorSessao);
