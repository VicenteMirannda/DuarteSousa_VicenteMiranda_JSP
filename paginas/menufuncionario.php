...
<div class="container center-buttons">
    <div class="row justify-content-center text-center">
        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <a href="gestao_carteira_func.php" class="btn btn-primary btn-menu w-100">Gerir Carteiras</a>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <a href="gerir_bilhetes_func.php" class="btn btn-primary btn-menu w-100">Gerir Bilhetes</a>
        </div>
